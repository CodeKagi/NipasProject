...
export default function Sidebar({ collapsed, setCollapsed }: SidebarProps) {
    const items = [
        ...
        {
            key: "2",
            icon: <img src={userProfileIcon} alt="User Profile" className="w-6 h-6" />,
            label: "User Profile"
        },
        {
            key: "3",
            icon: <img src={biodiversityProjectsIcon} alt="Biodiversity Projects" className="w-6 h-6" />,
            label: "Biodiversity Projects"
        },
        {
            key: "4",
            icon: <img src={stakeholderIcon} alt="Stakeholder" className="w-6 h-6" />,
            label: "Stakeholder"
        },
    ...
    return (
        <aside
            className="fixed bg-white border-[5px] border-[#3F842E] rounded-[50px] shadow-lg z-[999] flex flex-col"
            style={{
        ...
        >
            ...
            <div
                ...
                style={{ marginTop: collapsed ? "40px" : "4px", marginBottom: collapsed ? "40px" : "40px" }}
            >
                <img
