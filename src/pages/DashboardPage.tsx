...
/**
 * DashboardPage
 * - Shows a special Central Officer view when the user has the CENTRAL_OFFICER role
 * - Falls back to the existing generic dashboard otherwise
 */
...
export default function DashboardPage() {
  ...
  // --------------------------
  // prefer your real auth hook if you have one; otherwise check window.__USER__ (server-injected)
  const currentUser = React.useMemo(() => {
    // Uncomment if you have an auth hook
    // const auth = useAuth();
    ...
    return {
      name: "John Doe",
      roles: ["CENTRAL_OFFICER"], // change to ["CENTRAL_OFFICER"] to test the officer view
    };
  }, []);
  ...
  // --------------------------
  // Central Officer panel (styled to match design)
  // --------------------------
  // function OfficerTasksPanel() {
  //   // card definitions: color, light top band and values
  //   const cards = [
  //     {
  //       key: "pending",
  //       label: "Pending",
  ...
  //       value: 5,
  //       color: "#FF8A2B", // orange
  //       topBg: "#FFF5EE", // very light orange
  //     },
  //     {
  //       key: "completed",
  //       label: "Completed",
  //       subtitle: "No tasks",
  //       value: 0,
  //       color: "#9FD9B1", // soft green tint for border (use the brand green if preferred)
  //       topBg: "#F2FAF4", // very light green
  //     },
  //     {
  //       key: "deferred",
  //       label: "Deferred",
  ...
  //       {/* Header card (My Tasks) */}
  //       <div
  //         className="rounded-md bg-white p-5 shadow-[0_6px_10px_rgba(0,0,0,0.06)] border border-gray-200"
  ...
  //           <div
  //             key={c.key}
  //             className="rounded-md bg-white shadow-[0_6px_10px_rgba(0,0,0,0.04)] overflow-hidden"
  //             style={{
  //               border: `2px solid ${c.color}`,
  //               borderRadius: 8,
  //             }}
  //           >
  //             {/* top band with number and colored bottom border */}
  //             <div
  //               className="flex justify-end items-center px-4 py-3"
  //               style={{
  //                 background: c.topBg,
  //                 borderBottom: `2px solid ${c.color}`,
  //               }}
  //             >
  //               <span className="text-2xl sm:text-3xl font-extrabold" style={{ color: "#111827" }}>
  //                 {c.value}
  //               </span>
  //             </div>
  ...
  //           <div
  //             key={s.label}
  //             className="rounded-md p-4 shadow-[0_6px_10px_rgba(0,0,0,0.06)]"
  //             style={{
  //               background: s.bg,
  //               color: "white",
  //               borderRadius: 8,
